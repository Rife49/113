# Generated by Django 6.0.6 on 2026-06-10 01:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sluyg', models.SlugField(blank=True, max_length=100, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.CharField(blank=True, choices=[('cup', 'Cup'), ('tbsp', 'Tablespoon'), ('tsp', 'Teaspoon'), ('g', 'Grams'), ('kg', 'Kilograms'), ('ml', 'Milliliters'), ('l', 'Liters'), ('lb', 'Pounds'), ('piece', 'Piece'), ('pinch', 'Pinch'), ('to_taste', 'To taste')], max_length=20)),
                ('note', models.CharField(blank=True, max_length=200)),
                ('ingredient', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='recipe_ingredient', to='recipes.ingredient')),
